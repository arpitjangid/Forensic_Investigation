...
def fit(train_loader, val_loader, model, loss_fn, optimizer, scheduler, n_epochs, cuda, 
    ...
    for epoch in range(start_epoch, n_epochs):
        ...
        print(message)
        # save model, added -arpit
        if(epoch%save_freq == 0):
            print("saving model after {} epochs".format(epoch))
        ...
        ''' model load: 
        checkpoint = torch.load("../checkpoints/resnet_18_epoch_{}.pt")
        model = TripletNet(EmbeddingNet_ResNet18())
